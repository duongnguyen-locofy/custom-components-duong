...
})(this, (__WEBPACK_EXTERNAL_MODULE__883__, __WEBPACK_EXTERNAL_MODULE__845__) => {
...
var castSlice = __webpack_require__(754),
    hasUnicode = __webpack_require__(698),
    stringToArray = __webpack_require__(912),
...
var ThemeContext = external_React_default().createContext(null);
...
function useTheme() {
  var theme = external_React_default().useContext(useTheme_ThemeContext);
...
var StylesContext = external_React_default().createContext(defaultOptions);
...
function useSynchronousEffect(func, values) {
  var key = external_React_default().useRef([]);
  var output; // Store "generation" key. Just returns a new object every time

  var currentKey = external_React_default().useMemo(function () {
    return {};
...
function makeStyles(stylesOrCreator) {
  ...
  var useStyles = function useStyles() {
    ...
    var stylesOptions = extends_extends({}, external_React_default().useContext(StylesContext), stylesOptions2);

    var instance = external_React_default().useRef();
    var shouldUpdate = external_React_default().useRef();
...
{ var displayName; }
    ...
    var WithStyles = /*#__PURE__*/external_React_default().forwardRef(function WithStyles(props, ref) {
      ...
      return /*#__PURE__*/external_React_default().createElement(Component, extends_extends({
        ref: innerRef || ref,
        classes: classes
      }, more));
    });
...
var TouchRipple = /*#__PURE__*/external_React_.forwardRef(function TouchRipple(props, ref) {
  ...
  var startCommit = external_React_.useCallback(function (params) {
    ...
    setRipples(function (oldRipples) {
      return [].concat(toConsumableArray_toConsumableArray(oldRipples), [/*#__PURE__*/external_React_.createElement(ButtonBase_Ripple, {
        key: nextKey.current,
        classes: classes,
        timeout: DURATION,
        pulsate: pulsate,
  ...
  return /*#__PURE__*/external_React_.createElement("span", extends_extends({
...
{}
  ...
  return /*#__PURE__*/external_React_.createElement(ComponentProp, extends_extends({
  ...
  external_React_.createElement(ButtonBase_TouchRipple, extends_extends({
    ref: rippleRef,
    center: centerRipple
...
var Button = /*#__PURE__*/external_React_.forwardRef(function Button(props, ref) {
  ...
  return /*#__PURE__*/external_React_.createElement(ButtonBase_ButtonBase, extends_extends({
...
function styleFunctionSx(styleFunction) {
  var newStyleFunction = function newStyleFunction(props) {
    ...
    if (props.css) {
      return extends_extends({}, esm_merge(output, styleFunction(extends_extends({
        theme: props.theme
...
function styled_styled(Component) {
  var componentCreator = function componentCreator(style) {
    ...
    var name = options.name,
        stylesOptions = objectWithoutProperties_objectWithoutProperties(options, ["name"]);
...
{ var displayName; }
    ...
    var StyledComponent = /*#__PURE__*/external_React_default().forwardRef(function StyledComponent(props, ref) {
      var children = props.children,
          classNameProp = props.className,
          clone = props.clone,
          ComponentProp = props.component,
          other = objectWithoutProperties_objectWithoutProperties(props, ["children", "className", "clone", "component"]);
      ...
      if (clone) {
        return /*#__PURE__*/external_React_default().cloneElement(children, extends_extends({
          className: clsx_m(children.props.className, className)
        }, spread));
      }

      if (typeof children === 'function') {
        return children(extends_extends({
          className: className
        }, spread));
      }

      var FinalComponent = ComponentProp || Component;
      return /*#__PURE__*/external_React_default().createElement(FinalComponent, extends_extends({
        ref: ref,
        className: className
      }, spread), children);
    });
...
var styled = function styled(Component) {
  ...
  return function (style, options) {
    return componentCreator(style, extends_extends({
      defaultTheme: styles_defaultTheme
    }, options));
  };
};
...
var Typography = /*#__PURE__*/external_React_.forwardRef(function Typography(props, ref) {
  ...
  return /*#__PURE__*/external_React_.createElement(Component, extends_extends({
...
var upperFirst = __webpack_require__(808);
...
;// ./packages/core/core-typography/lib/styles.ts

/* harmony default export */ const lib_styles = (styles_makeStyles(theme => createStyles_createStyles({
  root: {
    maxWidth: ({
      fullWidth
    }) => fullWidth ? '100%' : 500
...
;// ./packages/core/core-typography/lib/index.tsx
function lib_extends() { return lib_extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, lib_extends.apply(null, arguments); }
 ...
 */
const lib_Typography = /*#__PURE__*/(0,external_React_.forwardRef)(({
  variant,
  className,
  classes,
  children,
  ...
  const baseClasses = lib_styles({
    fullWidth
  });
  const variantMatch = variant && variant.match(/(\w+)\.(\w+)/);
  const variantOverride = variantMatch && variantMatch[1] || variant;
  const fontWeight = variantMatch && `fontWeight${variantMatch[2].charAt(0).toUpperCase()}${variantMatch[2].slice(1)}`;
  const isThemeColor = color && Object.prototype.hasOwnProperty.call(baseClasses, `color${upperFirst_default()(color)}`);
  return /*#__PURE__*/React.createElement(Typography_Typography, lib_extends({
    variant: variantOverride,
    className: clsx(baseClasses.root, isThemeColor && baseClasses[`color${upperFirst_default()(color)}`], classes && classes.root, className, 'rupertong-typography')
  }, color && !isThemeColor ? {
    color: color
  } : {}, props, {
    ref: ref
...
/* harmony default export */ const lib = ((/* unused pure expression or super */ null && (lib_Typography)));

;// ./packages/core/core-button/lib/styles.ts

/* harmony default export */ const core_button_lib_styles = (styles_makeStyles(({
  palette,
  typography,
  shadows,
  transitions
}) => createStyles_createStyles({
  root: {
    minWidth: '88px'
  },
  label: {
...
;// ./packages/core/core-button/lib/index.tsx
function core_button_lib_extends() { return core_button_lib_extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, core_button_lib_extends.apply(null, arguments); }
...
const ButtonComponent = ({
  ...
  const baseClasses = core_button_lib_styles();
  const [pressed, setPressed] = (0,external_React_.useState)(false);
  const {
    onMouseUp,
    onMouseLeave,
    onMouseDown
  } = props;
  const onMouseEvent = down => {
  ...
  const sharedProps = {
    ...
    onClick: handleClick,
    onMouseUp: e => onMouseEvent(false) && onMouseUp && onMouseUp(e),
    onMouseLeave: e => onMouseEvent(false) && onMouseLeave && onMouseLeave(e),
    onMouseDown: e => onMouseEvent(true) && onMouseDown && onMouseDown(e),
    ref: ref || buttonRef,
    component
  };
  ...
  if (variant === 'icon') {
    ...
    return /*#__PURE__*/React.createElement(IconButton_IconButton, core_button_lib_extends({}, sharedProps, {
      classes: {
  ...
  return /*#__PURE__*/React.createElement(Button_Button, core_button_lib_extends({}, sharedProps, {
    variant: variant,
    size: size,
    classes: {
  ...
  }, props), /*#__PURE__*/React.createElement(lib_Typography, {
    variant: "button"
  }, children || label));
};
 ...
 */
const lib_Button = /*#__PURE__*/(0,external_React_.forwardRef)(ButtonComponent);
/* harmony default export */ const core_button_lib = (lib_Button);
...
{}
  ...
  var theme = external_React_default().useMemo(function () {
  ...
  return /*#__PURE__*/external_React_default().createElement(useTheme_ThemeContext.Provider, {
    value: theme
  }, children);
}
...
;// ./packages/core/core-theme/lib/palette.ts

const muiTheme = styles_createTheme();
const palette_color = {
  white: {
...
const primary = {
  main: palette_color.primary.main.op_100,
  dark: 'rgba(5, 87, 111, 1)',
  light: palette_color.primary.light.op_100
};
const success = {
...
const surface = {
  base: palette_color.white.op_100,
  dark: 'rgba(245, 245, 245, 1)',
  scrim: palette_color.black.op_50
};
const tabs = {
  default: palette_color.white.op_100,
  selected: palette_color.primary.main.op_12,
  hover: palette_color.primary.main.op_04,
  pressed: palette_color.primary.main.op_16
};
const tooltip = {
...
const chart = {
  ...
  goalLineColor: palette_color.black.op_100,
...
const palette_text = {
  dark: primary.dark,
  black: {
    highEmphasis: palette_color.black.op_88,
    medEmphasis: palette_color.black.op_64,
    disabled: palette_color.black.op_40
  },
  white: {
    highEmphasis: surface.base,
    medEmphasis: palette_color.white.op_88,
    disabled: palette_color.white.op_40
  }
};
const palette_border = {
  disabled: palette_color.black.op_12,
  enabled: palette_color.black.op_12,
  focus: palette_color.black.op_24,
  hover: palette_color.black.op_24,
  selected: palette_color.black.op_12,
  button: {
    enabled: palette_color.black.op_12,
    focused: palette_color.black.op_24
  },
  textField: {
    resting: palette_color.black.op_42,
    hover: palette_color.black.op_88,
    disabled: palette_color.black.op_16,
    error: error.main,
    focused: primary.main
  },
  chip: {
    resting: palette_color.black.op_32,
    focused: palette_color.black.op_32,
    pressed: palette_color.black.op_12
  }
};
const action = {
  activeBackground: palette_color.primary.light.op_50,
  disabledBackground: palette_color.black.op_12,
  dragBackground: palette_color.primary.light.op_70,
  focusBackground: palette_color.primary.light.op_60,
  hoverBackground: palette_color.black.op_04,
...
const iconButton = {
  active: palette_color.black.op_88,
  disabled: palette_color.black.op_40,
  enabled: palette_color.black.op_64,
  focus: palette_color.black.op_88,
  hover: palette_color.black.op_88,
...
const selectionControl = {
  on: {
    hover: palette_color.primary.main.op_04,
    focus: palette_color.primary.main.op_12,
    pressed: palette_color.primary.main.op_16
  },
  off: {
    hover: action.hoverBackground,
    focus: palette_color.black.op_12,
    pressed: palette_color.black.op_16
  }
};
...
/* harmony default export */ const lib_palette = (palette_palette);

;// ./packages/core/core-theme/lib/mixins.ts

const mixins_defaultTheme = styles_createTheme();
const mixins = {
  ...mixins_defaultTheme.mixins,
  toolbar: {
    ...mixins_defaultTheme.mixins.toolbar,
    [`@media(min-width:${mixins_defaultTheme.breakpoints.values.sm}px)`]: {
      minHeight: 48
    }
  }
};
/* harmony default export */ const lib_mixins = (mixins);
;// ./packages/core/core-theme/lib/oldPalette.ts

const oldPalette_muiTheme = styles_createTheme();
const oldPalette_color = {
  white: {
    op_40: 'rgba(255, 255, 255, 0.4)',
    op_88: 'rgba(255, 255, 255, 0.88)',
    op_100: 'rgba(255, 255, 255, 1)'
...
const oldPalette_primary = {
  main: oldPalette_color.primary.main.op_100,
  dark: 'rgba(44, 115, 0, 1)',
  light: oldPalette_color.primary.light.op_100
};
const oldPalette_warning = {
  main: 'rgba(255, 160, 0, 1)'
};
const oldPalette_error = {
  main: 'rgba(176, 0, 32, 1)'
};
const oldPalette_surface = {
  base: oldPalette_color.white.op_100,
  dark: 'rgba(245, 245, 245, 1)',
  scrim: oldPalette_color.black.op_50
};
const oldPalette_tabs = {
  default: oldPalette_color.white.op_100,
  selected: oldPalette_color.primary.main.op_12,
  hover: oldPalette_color.primary.main.op_04,
  pressed: oldPalette_color.primary.main.op_16
};
const oldPalette_tooltip = {
  background: 'rgba(66, 66, 66, 1)',
  color: oldPalette_surface.base,
  opacity: 0.8
};
const oldPalette_background = {
  default: oldPalette_surface.dark
};
const oldPalette_progressIndicator = {
  bar: oldPalette_primary.main,
  progress: oldPalette_primary.light
};
const oldPalette_chart = {
  categoricalPalette: ['rgba(158, 189, 224, 1)', 'rgba(243, 211, 95, 1)', 'rgba(244, 129, 68, 1)', 'rgba(151, 114, 177, 1)', 'rgba(82, 192, 182, 1)', 'rgba(224, 121, 175, 1)'],
  sequentialBluePalette: ['rgba(158, 189, 224, 1)', 'rgba(104, 150, 207, 1)', 'rgba(60, 123, 200, 1)', 'rgba(57, 102, 157, 1)', 'rgba(38, 68, 105, 1)', 'rgba(25, 46, 71, 1)'],
  emphasisPalette: {
    positive: 'rgba(170, 211, 161, 1)',
  ...
  barBackground: oldPalette_surface.base,
  altBarBackground: 'rgba(242, 242, 242, 1)',
  goalLineColor: oldPalette_color.black.op_100,
  projectedLineColor: 'rgba(211, 211, 211, 1)',
  barBorderColor: 'rgba(0, 160, 175, 1)'
};
const oldPalette_text = {
  dark: oldPalette_primary.dark,
  black: {
    highEmphasis: oldPalette_color.black.op_88,
    medEmphasis: oldPalette_color.black.op_64,
    disabled: oldPalette_color.black.op_40
  },
  white: {
    highEmphasis: oldPalette_surface.base,
    medEmphasis: oldPalette_color.white.op_88,
    disabled: oldPalette_color.white.op_40
  }
};
const oldPalette_border = {
  disabled: oldPalette_color.black.op_12,
  enabled: oldPalette_color.black.op_12,
  focus: oldPalette_color.black.op_24,
  hover: oldPalette_color.black.op_24,
  selected: oldPalette_color.black.op_12,
  button: {
    enabled: oldPalette_color.black.op_12,
    focused: oldPalette_color.black.op_24
  },
  textField: {
    resting: oldPalette_color.black.op_42,
    hover: oldPalette_color.black.op_88,
    disabled: oldPalette_color.black.op_16,
    error: oldPalette_error.main,
    focused: oldPalette_primary.main
  },
  chip: {
    resting: oldPalette_color.black.op_32,
    focused: oldPalette_color.black.op_32,
    pressed: oldPalette_color.black.op_12
  }
};
const oldPalette_action = {
  activeBackground: oldPalette_color.primary.light.op_50,
  disabledBackground: oldPalette_color.black.op_12,
  dragBackground: oldPalette_color.primary.light.op_70,
  focusBackground: oldPalette_color.primary.light.op_60,
  hoverBackground: oldPalette_color.black.op_04,
  disabled: 'rgba(153, 153, 153, 1)'
};
const oldPalette_containedButton = {
  active: oldPalette_muiTheme.palette.common.white,
  disabled: 'rgba(135, 135, 135, 1)',
  enabled: oldPalette_muiTheme.palette.common.white,
  focus: oldPalette_muiTheme.palette.common.white,
  hover: oldPalette_muiTheme.palette.common.white,
  activeBackground: 'rgba(69, 132, 31, 1)',
  disabledBackground: 'rgba(219, 219, 219, 1)',
  enabledBackground: oldPalette_primary.dark,
  focusBackground: 'rgba(69, 132, 31, 1)',
  hoverBackground: 'rgba(60, 125, 20, 1)'
};
const oldPalette_outlinedButton = {
  active: oldPalette_primary.dark,
  disabled: oldPalette_action.disabled,
  enabled: oldPalette_primary.dark,
  focus: oldPalette_primary.dark,
  hover: oldPalette_primary.dark,
  activeBackground: 'rgba(231, 243, 203, 1)',
  disabledBackground: 'transparent',
  enabledBackground: 'transparent',
  focusBackground: oldPalette_action.focusBackground,
  hoverBackground: oldPalette_surface.dark
};
const oldPalette_iconButton = {
  active: oldPalette_color.black.op_88,
  disabled: oldPalette_color.black.op_40,
  enabled: oldPalette_color.black.op_64,
  focus: oldPalette_color.black.op_88,
  hover: oldPalette_color.black.op_88,
  activeBackground: oldPalette_action.activeBackground,
  disabledBackground: 'transparent',
  enabledBackground: 'transparent',
  focusBackground: oldPalette_action.focusBackground,
  hoverBackground: oldPalette_action.hoverBackground
};
const oldPalette_textButton = {
  active: oldPalette_primary.dark,
  disabled: oldPalette_action.disabled,
  enabled: oldPalette_primary.dark,
  focus: oldPalette_primary.dark,
...
const oldPalette_selectionControl = {
  on: {
    hover: oldPalette_color.primary.main.op_04,
    focus: oldPalette_color.primary.main.op_12,
    pressed: oldPalette_color.primary.main.op_16
  },
  off: {
    hover: oldPalette_action.hoverBackground,
    focus: oldPalette_color.black.op_12,
    pressed: oldPalette_color.black.op_16
  }
};
const oldPalette_selectionSwitch = {
  rail: {
    on: {
  ...
  knob: {
    ...
    off: {
      enabled: oldPalette_surface.base,
      disabled: 'rgba(189, 189, 189, 1)'
    }
  }
};
const oldPalette_divider = 'rgba(224, 224, 224, 1)';
const oldPalette = {
  primary: oldPalette_primary,
  secondary: oldPalette_primary,
  warning: oldPalette_warning,
  error: oldPalette_error,
  surface: oldPalette_surface,
  tabs: oldPalette_tabs,
  tooltip: oldPalette_tooltip,
  background: oldPalette_background,
  progressIndicator: oldPalette_progressIndicator,
  chart: oldPalette_chart,
  text: oldPalette_text,
  border: oldPalette_border,
  action: oldPalette_action,
  button: {
    contained: oldPalette_containedButton,
    icon: oldPalette_iconButton,
    outlined: oldPalette_outlinedButton,
    text: oldPalette_textButton
  },
  selectionControl: oldPalette_selectionControl,
  switch: oldPalette_selectionSwitch,
  divider: oldPalette_divider
};
/* harmony default export */ const lib_oldPalette = (oldPalette);
;// ./packages/core/core-theme/lib/overrides.ts
const getOverrides = ({
  palette,
  breakpoints,
  typography,
...
/* harmony default export */ const overrides = (getOverrides);
;// ./packages/core/core-theme/lib/typography.ts
...
/* harmony default export */ const lib_typography = (typography_typography);
;// ./packages/core/core-theme/lib/index.ts
...
const lib_overrides = overrides(styles_createTheme({
  palette: lib_palette,
  typography: lib_typography
}));
const oldOverrides = overrides(styles_createTheme({
  palette: lib_oldPalette,
  typography: lib_typography
}));
const theme = styles_createTheme({
  palette: lib_palette,
  typography: lib_typography,
  overrides: lib_overrides,
  mixins: lib_mixins
});
const oldTheme = styles_createTheme({
  palette: lib_oldPalette,
  typography: lib_typography,
...
;// ./locofy/locofy-wrapper.tsx
/// <reference path="./theme.d.ts" />




// Define your custom theme. This should match the structure your components expect.
const customTheme = styles_createTheme({
  palette: lib_palette,
...
function LocofyWrapper({
  children
}) {
  return /*#__PURE__*/external_React_default().createElement(ThemeProvider_ThemeProvider, {
    theme: theme
  }, children);
}
...
const withWrapper = WrappedComponent => {
  return props => /*#__PURE__*/React.createElement(LocofyWrapper, null, /*#__PURE__*/React.createElement(WrappedComponent, props));
};
const WrappedButton = withWrapper(core_button_lib);
