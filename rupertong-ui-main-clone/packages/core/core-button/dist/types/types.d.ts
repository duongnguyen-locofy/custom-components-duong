...
export type ButtonProps<T extends ButtonVariants> = T extends TextButtonVariants ? RegularButtonProps<T> & Omit<MuiButtonProps, 'checkedLink' | 'valueLink'> : IconButtonProps & Omit<MuiIconButtonProps, 'checkedLink' | 'valueLink'>;
