...
export type TypographyVariant = 'h2.light' | 'h3.medium' | 'h4.medium' | 'caption.medium' | MuiTypographyProps['variant'];
export type TypographyColor = 'textDark' | 'textBlackHighEmphasis' | 'textBlackMedEmphasis' | 'textBlackDisabled' | 'textWhiteHighEmphasis' | 'textWhiteMedEmphasis' | 'textWhiteDisabled' | MuiTypographyProps['color'];
