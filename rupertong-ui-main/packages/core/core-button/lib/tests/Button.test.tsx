...
import { render } from '@rupertong-ui/utils-ui-testing';
...
describe('<Button />', () => {
  ...
  const LABEL = 'Test button' as string;
  ...
  it.each`
    ...
    ${'enabled, undefined variant, size small'} | ${{
  variant: undefined,
  size: 'small',
}} | ${[classes.regular.sizeSmall, classes.regular.textSizeSmall]}
    ${'enabled, undefined variant, size large'} | ${{
  variant: undefined,
  size: 'large',
}} | ${[classes.regular.sizeLarge, classes.regular.textSizeLarge]}
    ${'disabled, undefined variant'} | ${{
  variant: undefined,
  disabled: true,
}} | ${[classes.regular.disabled]}
